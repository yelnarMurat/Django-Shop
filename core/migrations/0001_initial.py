# Generated by Django 2.2.10 on 2020-10-04 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, upload_to='db_img/')),
                ('discount_price', models.FloatField(blank=True, null=True)),
                ('category', models.CharField(choices=[('W', 'Women'), ('M', 'Men'), ('CH', 'Child')], max_length=2)),
                ('label', models.CharField(choices=[('S', 'sale'), ('SO', 'stockout'), ('N', 'new')], max_length=1)),
